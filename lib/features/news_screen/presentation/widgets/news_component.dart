  ...
  Widget build(BuildContext context) {
    ...
    builder: (context, state) {
      if(state is ArticlesSuccess ){
        ...
        return state.articles.isEmpty ? Text('No Data',style: colorStyle.sourcesSelectedLableStyleB700,):
        Expanded(
                ...
                child: Column(
                  children: [
                    ClipRRect(
                      ...
                      child:state.articles[index].urlToImage==null?Image.asset('assets/images/un_avillable.png'): Image.network(
                    ...
                    Row(
                      ...
                      children: [
                        // TODO: handle null
                        Text("By ${blocArticles.getAuthor(state.articles[index].author)}",style: colorStyle.m500_12,),
